...
// =========================================================================
//  Privasys configuration OIDs  (PEN 1337 — placeholder, pending IANA)
// =========================================================================

/// Config Merkle Root — `1.3.6.1.4.1.1337.1.1`
///
...
pub const CONFIG_MERKLE_ROOT_OID_STR: &str = "1.3.6.1.4.1.1337.1.1";

/// Egress CA Bundle Hash — `1.3.6.1.4.1.1337.2.1`
///
...
pub const EGRESS_CA_HASH_OID_STR: &str = "1.3.6.1.4.1.1337.2.1";

/// WASM Apps Combined Code Hash — `1.3.6.1.4.1.1337.2.3`
///
...
pub const WASM_APPS_HASH_OID_STR: &str = "1.3.6.1.4.1.1337.2.3";
