...
pub extern "C" fn ecall_run(config_json: *const u8, config_len: u64) -> i32 {
    ...
    enclave_os_common::ocall::register(enclave_os_common::ocall::OcallVtable {
        ...
        net_udp_bind:      crate::ocall::net_udp_bind,
        net_udp_send_to:   crate::ocall::net_udp_send_to,
        net_udp_recv_from: crate::ocall::net_udp_recv_from,
        net_udp_close:     crate::ocall::net_udp_close,
